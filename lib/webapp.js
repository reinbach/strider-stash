...
module.exports = {
    ...
    setupRepo: function (account, config, project, done) {
        ...
        api.createHook(owner, repo, url, account.token, account.tokenSecret, function (err) {
    ...
    teardownRepo: function (account, config, project, done) {
        ...
        api.deleteHook(owner, repo, url, account.token, account.tokenSecret, function (err, deleted) {
            if (err) return done(err);
            return done();
        });
    },
